...
responses2 = db.responses2
allwords2 = db.allwords2
...
talkClass2 = talkLoop(client, db, responses2, allwords2, inputWords, globalReply, botAccuracy, botAccuracyLower)
talkClass.updateDB(inputWords, globalReply)
talkClass2.updateDB(inputWords, globalReply)
inputWords = (talkClass.replyTumbler())
talkClass.updateDB(inputWords, globalReply)
globalReply = (talkClass.replyTumbler())
globalReply2 = globalReply
...
while True:
	...
	talkClass2.updateDB(globalReply, globalReply2)
	globalReply2 = (talkClass2.replyTumbler())	
	sys.stdout.write(RED)
	print (globalReply2)
	sys.stdout.write(RESET)
	if inputWords == (""):
		continue
	talkClass.updateDB(globalReply2, globalReply)
	globalReply = (talkClass.replyTumbler())
	sys.stdout.write(BLUE)
	print(globalReply)
	sys.stdout.write(RESET)
